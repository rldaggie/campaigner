...
class KeywordsControllerTest < ActionController::TestCase
  ...
  test "should create keyword" do
    assert_difference('Keyword.count') do
      post :create, keyword: { campaign_id: @keyword.campaign_id, clicks_per_day: @keyword.clicks_per_day, cost_per_click: @keyword.cost_per_click, name: @keyword.name }
    end
  ...
  test "should update keyword" do
    patch :update, id: @keyword, keyword: { campaign_id: @keyword.campaign_id, clicks_per_day: @keyword.clicks_per_day, cost_per_click: @keyword.cost_per_click, name: @keyword.name }
    assert_redirected_to keyword_path(assigns(:keyword))
  end
